...
import ChampionsLeague23_24 from './JsonData/ChampionsLeague/23-24_ChampionsLeague_data.json';
import ChampionsLeague22_23 from './JsonData/ChampionsLeague/22-23_ChampionsLeague_data.json';
import ChampionsLeague21_22 from './JsonData/ChampionsLeague/21-22_ChampionsLeague_data.json';
...
const PlayerData_CL = () => {
  ...
  if (selectedTag == '23-24') {
    data = ChampionsLeague23_24;
  } else if (selectedTag == '22-23') {
    data = ChampionsLeague22_23;
  } else if (selectedTag == '21-22') {
    data = ChampionsLeague21_22;
  } else {
    data = ErrorData;
  }
  ...
  const renderItem = ({ item }) => {
    return (
      <TouchableOpacity 
        ...
        onPress={() => router.push(`./PlayerDataDetail?Rk=${item.Rk}&Season=${selectedTag}&League=CL`)}
      >
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pickerContainer}>
        ...
        >
          ...
          <Picker.Item label="23-24시즌 챔피언스리그" value="23-24" />
          <Picker.Item label="22-23시즌 챔피언스리그" value="22-23" />
          <Picker.Item label="21-22시즌 챔피언스리그" value="21-22" />
        </Picker>
      </View>
      ...
      {followData ? //followData가 undefined인 경우 대비
        <TouchableOpacity 
        style={styles.follow}
        onPress={() => router.push(`./PlayerDataDetail?Rk=${followData.Rk}&Season=${selectedTag}&League=CL`)} >
          <View style={styles.row}>
