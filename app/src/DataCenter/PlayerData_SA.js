  ...
  const renderItem = ({ item }) => {
    return (
      <TouchableOpacity 
        ...
        onPress={() => router.push(`./PlayerDataDetail?Rk=${item.Rk}&Season=${selectedTag}&League=SA`)}
      >
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pickerContainer}>
        ...
        >
          ...
          <Picker.Item label="23-24시즌 세리에A" value="23-24" />
          <Picker.Item label="22-23시즌 세리에A" value="22-23" />
          <Picker.Item label="21-22시즌 세리에A" value="21-22" />
        </Picker>
      </View>
      ...
      {followData ? //followData가 undefined인 경우 대비
        <TouchableOpacity 
        style={styles.follow}
        onPress={() => router.push(`./PlayerDataDetail?Rk=${followData.Rk}&Season=${selectedTag}&League=SA`)} >
          <View style={styles.row}>
